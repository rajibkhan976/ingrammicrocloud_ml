...
class Ju_Updater {
	...
	protected function installHooks(){
		...
		add_filter('upgrader_source_selection', array($this, 'fixDirectoryName'), 10, 3);
                add_action( 'admin_enqueue_scripts', array($this, 'ju_load_custom_wp_admin_script') );
	...
	<script type="text/javascript">
        ...
        public function ju_load_custom_wp_admin_script() {
            ...
            if($pagenow == 'plugins.php' || $pagenow == 'options-general.php'){
                wp_register_script('check_token', plugins_url( '/juupdater/js/check_token.js', dirname(__FILE__) ),array());
                wp_enqueue_script('check_token');
            }
            
            if($pagenow == 'update-core.php'){
                wp_register_script('ju_update_core', plugins_url( '/juupdater/js/ju_update_core.js', dirname(__FILE__) ),array());
