<?php class WPUEF_UserProfileFormsAddon
{
	public function __construct()
	{
		...
		add_action('bp_custom_profile_edit_fields', array( &$this, 'buddypress_edit_profile_extra_fields'));
		...
		add_action( 'woocommerce_after_checkout_billing_form', array( &$this, 'woocommerce_add_checkout_extra_user_fields' ), 10, 1 );
	...
	public function buddypress_edit_profile_extra_fields()
	{
		...
		$user_id = bp_displayed_user_id();
		if(isset($user_id) && $user_id > 0)
			$wpuef_htmlHelper->render_edit_table_with_extra_fields($user_id);
	}
