			...
			<div class="container">
				<div class="row">
					<div id="left-column" class="col-md-4 col-sm-4">
						<div class="row">
							<div id="icon" class="col-md-3 col-sm-3"></div>
					...
					<section id="panel-body">
						<div id="marketplace-container">
							<div id="header-text">
								...
								<h4>Research and purchase cloud security applications with real-time ordering, provisioning, managing and invoicing though the Ingram Micro Cloud Marketplace.</h4>
							</div>
							<div id="category-solutions" class="text-center"><i class="fa fa-circle-o-notch fa-spin fa-3x"></i></div>
						</div>
						<div id="catalog-container-security" class="row"></div>
					</section>
				</div>
