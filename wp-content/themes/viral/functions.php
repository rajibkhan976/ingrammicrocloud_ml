...
function main_styles() {
	...
	wp_enqueue_style( 'jquery-modal-css', get_template_directory_uri() . '/css/jquery.modal.css', true );
	wp_enqueue_style( 'template-brazil-custom-landing-page-head', get_template_directory_uri() . '/css/template-brazil-custom-landing-page-head.css', true );
	wp_enqueue_style( 'template-brazil-custom-landing-page-main', get_template_directory_uri() . '/css/template-brazil-custom-landing-page-main.css', true );
...
function register_menus() {
	register_nav_menus(array('primary-menu' => 'Primary Navigation Menu','onepage-menu' => 'Onepage Menu','super-menu' => 'Super Menu'));
}
