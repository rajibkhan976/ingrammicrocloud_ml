(function ($) {
    ...
    JuupdatePlugin = function (plugin, slug) {
        if (slug == 'wp-media-folder' || slug == 'wp-file-download' || slug == 'wp-team-display' || slug == 'wp-latest-post' || slug == 'wp-table-manager') {
            if (token && token != '') {
    ...
    $(document).ready(function () {
        var ju_plugins = ['wp-media-folder','wp-file-download','wp-team-display','wp-latest-post','wp-table-manager'];
