...
this["Formbuilder"]["templates"]["edit/checkboxes"] = function(obj) 
{
	...
	with (obj) 
	{
		...
		'\' />\n  Required (for "Checkbox" type, all options will be required to be checked. Does not work with date and time pickers)\n</input>\n<!-- <label>\n  <input type=\'checkbox\' data-rv-checked=\'model.' +
		((__t = ( Formbuilder.options.mappings.ADMIN_ONLY )) == null ? '' : __t) +
		'\' />\n  Admin only\n</label> -->';

		__p += '<br/><br/><input type=\'checkbox\' data-rv-checked=\'model.editable_only_by_admin\' />\n Editable <strong>ONLY</strong> by Admin (User can see the field on its profile page but cannot edit it. <strong>If enabled, checkout options will be ignored</strong>).</input>';
		
		__p += '<br/><br/><input type=\'checkbox\' data-rv-checked=\'model.visible_only_at_register_page\' />\n Visible <strong>ONLY</strong> in the register page (The field will <strong>NOT</strong> visible in user profile page';
		if(woocommerce_is_active)
			__p += '. WooCommerce visibility options will be ignored';
		__p +=').</input>';
			
		__p += '<br/><br/><input type=\'checkbox\' data-rv-checked=\'model.hide_in_the_register_page\' />\n Hide in the register page. If checked previous option will be ignored. (By default a field is showed in both register and user account page).</input>';
		...
		if(woocommerce_is_active)
		{
			...
			__p +='<h4>Checkout</h4>';
			__p += '<input type=\'checkbox\' data-rv-checked=\'model.woocommerce_visible_on_checkout\' />\n Visible on Checkout page. If enabled, customer will be able to edit this field during Checkout. <br/><strong>NOTE:</strong> Field will not be saved if guest checkout is allowed</input><br/><br/>';
			...
			__p += '<h4>Visble and Editable (according to edit restricion options) in following pages</h4>';
