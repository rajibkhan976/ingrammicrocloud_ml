					...
					<section id="panel-body">
						<div id="marketplace-container">
							<div id="header-text">
								...
								<h4>Research and purchase cloud communication & collaboration applications with real-time ordering, provisioning, managing and invoicing though the Ingram Micro Cloud Marketplace.</h4>
							</div>
							<div id="category-solutions" class="text-center"><i class="fa fa-circle-o-notch fa-spin fa-3x"></i></div>
						</div>
						<div id="catalog-container-cc" class="row"></div>
					</section>
				</div>
