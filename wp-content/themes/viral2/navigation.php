...
<div class="upper-nav-bar">
	<div class="container">
		<div class="sixteen columns">
			...
			<div id="super-menu">
			<?php wp_nav_menu( array( 'theme_location' => 'super-menu', 'depth' => 2, 'menu_id' => ' ', 'container' => false, 'menu_class' => 'nav' ) ); ?>
			</div><!-- /super-menu -->
		...
		<div id="menu" class="thirteen columns">
			<div class="container-menu fa">
				...
				<?php
					...
					} else echo '<a href="'.home_url().'/wp-admin/nav-menus.php">Configure Menu</a>';
					
				} else {
				
				
					if (has_nav_menu( 'primary-menu' )) {
   					wp_nav_menu(array('container' => '', 'menu_id' => 'primary-menu', 'menu_class' => 'nav', 'theme_location' => 'primary-menu'));
					} else echo '<a href="'.home_url().'/wp-admin/nav-menus.php">Configure Menu</a>';
				?>
