...
function icl_lang_sel_nav_css( $show = true ) {
	...
	$link_tag = '<link rel="stylesheet" href="http://www.ingrammicrocloud.com/wp-content/plugins/sitepress-multilingual-cms/res/css/language-selector.css?v=' . ICL_SITEPRESS_VERSION . '" type="text/css" media="all" />';
