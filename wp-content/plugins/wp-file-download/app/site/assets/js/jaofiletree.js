...
(function( $ ) {
    ...
    var methods = {
        init : function( o ) {
            ...
            if(options.showroot!=''){
                ...
                $this.html('<ul class="jaofiletree"><li class="drive directory collapsed selected"><a href="#" data-file="'+options.root+'" data-type="dir">'+options.showroot+'</a></li></ul>');
            }
		...
		dataType: 'json',
                ...
                for(ij=0; ij<datas.length; ij++){
                    ...
                    if(datas[ij].count_child > 0){
                        ...
                        ret += '<div class="icon-open-close" data-id="' + datas[ij].term_id + '" data-parent_id="' + datas[ij].parent + '" data-file="' +datas[ij].term_id + '"  style="opacity:0"></div>';
                    }
                    selectedId = dir;
    ...
    setevents = function(){
        ...
        $this.find('li.directory a').bind('click', function() {            
            ...
            $this.find('i.md').removeClass('md-folder-open').addClass("md-folder");
