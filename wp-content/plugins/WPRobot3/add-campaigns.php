...
<form method="post" id="wpr_new">
	...
	<table class="addt" width="100%">
		...
		<tr>
			...
			<td>
			<?php _e('- BrowseNodes are IDs used by Amazon to categorize all their products.<br/>
			- <strong>Important:</strong> You have to specify the correct Amazon Department the BrowseNodes belong to!<br/>
			- To find the IDs <a target="_blank" href="http://amazon.com/computer-video-games-hardware-accessories/b/ref=nav_shopall_cvg?ie=UTF8&node=468642&tag=metally-20">browse Amazon categories</a> and look for the "&node=<strong>468642</strong>" part in the URL.',"wprobot") ?>
			</td>
		</tr>		
		<?php } ?>		
		<tr>
	...
	<?php if($_POST['tnum'] == 0 && $skippedx > 0) { ?>
		...
		<div class="addt"><p><?php _e("<strong>Please note:</strong> ","wprobot"); echo $skippedx; _e(' of your modules were hidden. You need to configure them on the <a href="?page=wpr-options" target="_blank">Options page</a> first.',"wprobot"); ?></p></div>		
