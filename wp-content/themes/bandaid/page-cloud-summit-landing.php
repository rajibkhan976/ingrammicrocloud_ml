    ...
    <section class="panel1 cloud-summit-page" style="display:block; clear:both; position: relative;">
        <div class="video-container" >
            <video poster="<?php echo get_template_directory_uri(); ?>/img/landing-page/landing_page_video.png" autoplay loop muted>
                <source type="video/mp4" src="<?php echo get_template_directory_uri(); ?>/video/ocean.mp4">
                <source type="video/webm" src="<?php echo get_template_directory_uri(); ?>/video/ocean.webm">
                <source type="video/ogg" src="<?php echo get_template_directory_uri(); ?>/video/ocean.ogv">
            </video>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-xs-6">
                            <img class="img-responsive" src="/wp-content/uploads/2016/11/rise_above.png">
                        </div>				
                    </div>
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="play-btn-text text-center" style="text-align: center; margin:40px auto;">
                                <img class="img-responsive" src="/wp-content/uploads/2016/11/perspective.png" align="center" style="margin: auto;">
                            </div>
                        </div>
                    </div>
                </div> 
			...
			<div class="row">
                <div class="col-sm-8">			
					...
					<div class="registration-section">
						<h4><strong>Register by January 15, 2017 and save $100!</strong></h4>
            ...
            <div class="why-should">
                ...
                <ul style="padding-left: 18px;">
                    ...
                    <ul style="padding-left: 38px;">
                        <li>Transformational Leadership - Transcend the hype and go beyond the buzzwords. Attendees will gain valuable insight on how to become change agents and drive new levels of success with the evolving cloud opportunity.</li>
                        <li>Innovation Track - Witness real-world examples of true innovation. Focusing on case studies, industry trends, best practices, and new product innovations, attendees will discover new ways to achieve innovation by pushing the envelope.</li>
                        <li>Education Track - Learn why Cloud is the fastest growing segment of the technology market. Attendees of these sessions will acquire valuable knowledge on the latest tools and technologies in the Ingram Micro Cloud Marketplace that help automate and transform productivity.</li>
                    </ul>
                ...
                <div class="row">
                        ...
                        <div class="col-sm-5 col-xs-12">
                        	<div class="row">
                                ...
                                <div class="row col-sm-9 col-xs-8">
