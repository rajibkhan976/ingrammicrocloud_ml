                ...
                <div class="tab-content" id="myTabContent">
                    <div class="tab-pane fade active in" role="tabpanel" id="latest-news" aria-labelledby="latest-news-tab">
                        <div class="col-md-9 col-sm-12">
                            ...
                            <h2>News Releases</h2>
                            <?php
                            //query_posts("post_type=post &posts_per_page=3&cat=" . get_cat_ID('Press Releases') . '&orderby=date&order=DESC');
...
//                                    $post_id = get_the_ID();
                            ...
                            <!--                            <div class="newsroom-archived">
                                                            <a href="/latest-news-releases/" class="page-scroll">
                                                                <button class="btn btn-default btn-outline-gray">News releases continued &gt;</button>
                                                            </a>
                                                        </div>-->
                            <div class="spacer"></div>
                        </div>
                        ...
                        <div class="col-md-9 col-sm-9">
                            ...
                            <div class="row" style="margin-bottom: 15px;">
                                <div class="col-sm-12">
                                    <h2>In The News</h2>
                                    <?php
                                    //query_posts("post_type=post &posts_per_page=20 &cat=" . get_cat_ID('In The News') . '&orderby=date&order=DESC');
