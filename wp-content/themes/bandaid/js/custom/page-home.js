...
jQuery(document).ready(function () {
    ...
    jQuery.post({
        url: '/wp-content/themes/bandaid/inc/home_page_carousel.php',
        beforeSend: function () {
        ...
        success: function (data) {            
            ...
            jQuery.each(data, function (index, value) {
                ...
                if (row.status == "SUCCESS") {
                    html_data += '<div data-thumb="' + row.placements.placement_1.image_url + '">';
                    html_data += '<a href="' + row.placements.placement_1.redirect_url + '"';
                    if (row.placements.placement_1.target) {
                        html_data += 'target="' + row.placements.placement_1.target + '">';
                    }
                    html_data += '<img src="' + row.placements.placement_1.image_url + '" alt="' + row.placements.placement_1.alt_text + '"></a>';
                    html_data += '<img src="' + row.placements.placement_1.accupixel_url + '" alt="' + row.placements.placement_1.alt_text + '">';
                    html_data += '</div>';
                }
            });

            jQuery('#panel-promotions').html(html_data);
            renderPromotions();
        },
