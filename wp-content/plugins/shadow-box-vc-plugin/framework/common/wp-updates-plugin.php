...
new WPUpdatesPluginUpdater_796( 'http://wp-updates.com/api/2/plugin', plugin_basename(__FILE__) );
*/
...
if( !class_exists('WPUpdatesPluginUpdater') ) {
    class WPUpdatesPluginUpdater {
    	...
    	function __construct( $plugin_id, $api_url, $plugin_path, $license_key = null ) {
