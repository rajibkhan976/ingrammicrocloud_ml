...
$country_code = $url_paths[2];
$current_language = $url_paths[2];
...
//
    ...
    foreach ($col0 as $c0) {
        ...
        foreach ($category_subs as $csubs) {
            ...
            $col0_structure_page .= '<li class="ubermenu-item ubermenu-item-type-custom ubermenu-item-object-custom ubermenu-item-auto ubermenu-item-normal ubermenu-item-level-9 ubermenu-column ubermenu-column-auto"><a class="ubermenu-target ubermenu-item-layout-default ubermenu-item-layout-text_only" href="https://' . $country_code . '.cloud.im' . $csubs_url . '"><span class="ubermenu-target-title ubermenu-target-text" style="font-size: 15px; color: #131313;">' . $csubs_category_name . '</span></a></li>';
...
//
    ...
    foreach ($rightcol as $rcol) {
        ...
        if ($category_url == '') {
            ...
            $rightcol_structure .= '<a class="ubermenu-target ubermenu-item-layout-default ubermenu-item-layout-text_only" href="' . $category_url . '">';
        }
