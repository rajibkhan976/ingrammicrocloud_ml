		...
		<div class="container">
			<div class="row">
				<div class="col-md-3 col-sm-3">
					...
					<img class="img-responsive" src="<?php echo get_template_directory_uri(); ?>/img/page-become-a-partner/image.png"></img>
				</div>
				<div class="col-md-9 col-sm-9">
					...
					<p>Regardless if you are a small to mid-sized reseller, solution provider, enterprise, operator, carrier, telco, hoster, MSP or OEM, Ingram Micro Cloud has the relationships, infrastructure, and expertise to help you monetize and manage any offerings.  This includes security, communication & collaboration, business applications, infrastructure, web presence, vertical solutions, cloud management and XaaS, all with confidence, speed and agility. Learn more about Partnership opportunities below.</p>
				</div>
			</div>
		</div>
	</div>
	<div id="panel-tabs" class="container">
		<div class="bs-example bs-example-tabs" data-example-id="togglable-tabs">
		  <ul class="nav nav-tabs" id="myTabs" role="tablist">
		    <li role="presentation" class="active"><a href="#reseller" id="reseller-tab" role="tab" data-toggle="tab" aria-controls="reseller" aria-expanded="true"><strong>Become a Reseller</strong></a>
		    </li>
		    <li role="presentation" class=""><a href="#vendor" role="tab" id="vendor-tab" data-toggle="tab" aria-controls="vendor" aria-expanded="false"><strong>Become a Vendor</strong></a>
		    </li>
		  </ul>
		    ...
		    <div class="tab-pane fade active in" role="tabpanel" id="reseller" aria-labelledby="reseller-tab">
		    	...
		    	<div class="row" style="margin: 40px 0;">
		      	<div class="col-md-6 col-sm-6">
		      		<div class="row">
				      		<div class="col-md-3 col-sm-3"><img class="img-responsive" src="<?php echo get_template_directory_uri(); ?>/img/page-become-a-partner/education.png"></img></div>
			      		...
			      		<div class="row">
				      		<div class="col-md-3 col-sm-3"><img class="img-responsive" src="<?php echo get_template_directory_uri(); ?>/img/page-become-a-partner/marketing.png"></img></div>
				      		<div class="col-md-9 col-sm-9">
				      			<p>
		      	...
		      	<div class="col-md-6 col-sm-6">
		      		<div class="row">
			      		<div class="col-md-3 col-sm-3"><img class="img-responsive" src="<?php echo get_template_directory_uri(); ?>/img/page-become-a-partner/tech-support.png"></img></div>
			      	...
			      	<div class="row">
			      		<div class="col-md-3 col-sm-3"><img class="img-responsive" src="<?php echo get_template_directory_uri(); ?>/img/page-become-a-partner/financing.png"></img></div>
			      		<div class="col-md-9 col-sm-9">
			      			<p>
		    	...
		    	<div>
		      	<p>If you are interested in joining nearly 200,000 solutions providers around the world who look to Ingram Micro for their technology needs, please complete the reseller partner application form below and we will contact you within 48 hours.</p>
		      	<br />
		      	<a href="http://www.ingrammicrocloud.com/become-a-reseller/" class="a-no-underline"><button class="btn btn-outline-gray center-block"><img src="<?php echo get_template_directory_uri(); ?>/img/page-become-a-partner/reseller-button-icon.png">Become a Cloud Reseller Today</button></a>
		    	</div>
		    </div>
		    <div class="tab-pane fade" role="tabpanel" id="vendor" aria-labelledby="vendor-tab">
		    	<div>
		      	<p>As the largest technology distributor in the world, Ingram Micro connects industry leading Cloud vendors and ISV's with global and local markets to generate demand for your solutions, deliver automated cloud services, and manage and support users on your behalf.</p>
		    	</div>
	      	<div class="row" style="margin: 40px 0;">
	      		<div class="col-md-4 col-sm-4">
	      			<img class="img-responsive center-block" src="<?php echo get_template_directory_uri(); ?>/img/page-become-a-partner/demand-gen.png"></img>
	      			<br />
      				...
      				<p>Position and promote your products and services through our international campaign initiatives, the largest reseller community in the world, including global telco's and large hosters, and the industry's most complete ecommerce catalog of over 200 vetted cloud solutions.</p>
						...
						<div class="col-md-4 col-sm-4">
	      			<img class="img-responsive center-block" src="<?php echo get_template_directory_uri(); ?>/img/page-become-a-partner/cloud-platforms.png"></img>
	      			<br />
	    			...
	    			<div class="col-md-4 col-sm-4">
	      			<img class="img-responsive center-block" src="<?php echo get_template_directory_uri(); ?>/img/page-become-a-partner/support.png"></img>
	      			<br />
	      	...
	      	<div>
		      	<p>If you are interested in joining nearly 200,000 solutions providers around the world who look to Ingram Micro for their technology needs, please complete the vendor partner application form below and we will contact you within 48 hours.</p>
		      	<br />
		      	<a href="http://www.ingrammicrocloud.com/vendor-profile/" class="a-no-underline"><button class="btn btn-outline-gray center-block"><img src="<?php echo get_template_directory_uri(); ?>/img/page-become-a-partner/vendor-button-icon.png">Become a Cloud Vendor Today</button></a>
	      	</div>
		    </div>
		  </div>
		</div>
